...
class ProtossAgent(base_agent.BaseAgent):
    ...
    def __init__(self):
        ...
        #                 "train_zealot",
        #                 "attack")
        self.actions = ["build_assimilator"]
        self.pylon_coords = []
        # self.pylon_index = 0
    ...
    def step(self, obs):
        ...
        if obs.first():
            ...
            self.pylon_coords = [(22, 27), (25, 29), (19, 29)] if self.base_top_left else [(35, 40), (32, 46), (38, 47)]
    ...
    def build_pylon(self, obs):
        ...
        # if pylons_active > 0:
        #     print("radius: " + str(pylons[0].radius))
